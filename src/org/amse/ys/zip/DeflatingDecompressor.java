...
class DeflatingDecompressor extends Decompressor {
    ...
    private void fillOutBuffer() throws IOException {
        ...
        while (myOutBufferLength == 0) {
            ...
            if (result <= 0) {
                final StringBuilder extraInfo = new StringBuilder().append(myStream.offset()).append(":").append(myInBufferOffset).append(":")
                        .append(myInBufferLength).append(":").append(myOutBuffer.length).append(":");
