...
public class LibraryActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener,
        IBookCollection.Listener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        FBDebug.logLibTree("LibraryActivity.onCreate occured:"+mySelectedBook);
        ...
        myCollection.bindToService(this, new Runnable() {
            @Override
            public void run() {
                FBDebug.logLibTree("LibraryActivity->myCollection.bindToService occured");
    ...
    protected void onNewIntent(Intent intent) {
        FBDebug.logLibTree("LibraryActivity.onNewIntent :"+intent.getAction());
    ...
    protected LibraryTree getTreeByKey(FBTree.Key key) {
        FBDebug.logLibTree("LibraryActivity.getTreeByKey() :"+key);
    ...
    private void tryToDeleteBooks(List<Book> books) {
        ...
        new AlertDialog.Builder(this).setTitle(title).setMessage(message).setIcon(0)
