...
public class CancelActivity extends ListActivity {
    ...
    protected void onStart() {
        super.onStart();
        // we use this local variable to be sure collection is not null inside
        // the runnable
    ...
    private class ActionListAdapter extends BaseAdapter implements AdapterView.OnItemClickListener {
        ...
        public View getView(int position, View convertView, final ViewGroup parent) {
            final View view = convertView != null ? convertView : LayoutInflater.from(parent.getContext()).inflate(R.layout.cancel_item, parent,
                    false);
