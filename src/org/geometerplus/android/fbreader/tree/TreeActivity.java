...
public abstract class TreeActivity<T extends FBTree> extends ListActivity {
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        FBDebug.logLibTree("TreeActivity.onNewIntent:"+intent.getAction());
    ...
    protected void init(Intent intent) {
        ...
        FBDebug.logLibTree("TreeActivity.init():"+key+"|"+selectedKey);
        FBDebug.logLoadBook("TreeActivity.init():"+key+"|"+selectedKey);
    ...
    private void openTreeInternal(FBTree tree, FBTree treeToSelect, boolean storeInHistory) {
        ...
        case ALWAYS_RELOAD_BEFORE_OPENING:
            ...
            onNewIntent(new Intent(this, getClass()).setAction(OPEN_TREE_ACTION).putExtra(TREE_KEY_KEY, tree.getUniqueKey())
                    .putExtra(SELECTED_TREE_KEY_KEY, treeToSelect != null ? treeToSelect.getUniqueKey() : null)
