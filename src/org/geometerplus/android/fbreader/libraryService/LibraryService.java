...
public class LibraryService extends Service {
    ...
    public final class LibraryImplementation extends LibraryInterface.Stub {
        ...
        public String getBookByFile(String path) {
            FBDebug.logLoadBook("LibraryService.getBookByFile(String path) "+path);
        ...
        public void storePosition(long bookId, PositionWithTimestamp pos) {
            ...
            myCollection.storePosition(bookId, new ZLTextFixedPosition.WithTimestamp(pos.ParagraphIndex, pos.ElementIndex, pos.CharIndex,
                    pos.Timestamp));
        }
        ...
        public List<String> bookmarks(String query) {
            return SerializerUtil.serializeBookmarkList(myCollection.bookmarks(SerializerUtil.deserializeBookmarkQuery(query)));
        }
