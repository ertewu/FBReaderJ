...
public class ZLNetworkManager {
    ...
    private static class AuthScopeKey {
        ...
        public boolean equals(Object obj) {
            ...
            return myScope.getPort() == scope.getPort() && MiscUtil.equals(myScope.getHost(), scope.getHost())
                    && MiscUtil.equals(myScope.getScheme(), scope.getScheme()) && MiscUtil.equals(myScope.getRealm(), scope.getRealm());
        }
        ...
        public int hashCode() {
            ...
            return myScope.getPort() + MiscUtil.hashCode(myScope.getHost()) + MiscUtil.hashCode(myScope.getScheme())
    ...
    private static class Key {
        ...
        public boolean equals(Object o) {
            ...
            final Key k = (Key) o;
            return MiscUtil.equals(Domain, k.Domain) && MiscUtil.equals(Path, k.Path) && MiscUtil.equals(Name, k.Name);
        }

        @Override
        public int hashCode() {
            return MiscUtil.hashCode(Domain) + MiscUtil.hashCode(Path) + MiscUtil.hashCode(Name);
        }
    };
