...
public final class ZLTextWritablePlainModel extends ZLTextPlainModel implements ZLTextWritableModel {
    ...
    public ZLTextWritablePlainModel(String id, String language, int arraySize, int dataBlockSize, String directoryName, String extension,
            Map<String, ZLImage> imageMap, FontManager fontManager) {
        super(id, language, new int[arraySize], new int[arraySize], new int[arraySize], new int[arraySize], new byte[arraySize],
                new CachedCharStorage(dataBlockSize, directoryName, extension), imageMap, fontManager);
    }
