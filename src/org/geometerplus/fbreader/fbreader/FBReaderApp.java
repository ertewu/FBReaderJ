...
public final class FBReaderApp extends ZLApplication {
    ...
    public void openBook(Book book, final Bookmark bookmark, Runnable postAction, Notifier notifier) {
        ...
        if (book == null) {
            ...
            if (book == null) {
                //一般来说非第一次打开程序时，都是打开上一次的书，其实就是走这里了
    ...
    public void addInvisibleBookmark(ZLTextWordCursor cursor) {
        ...
        synchronized (textView) {
            ...
            updateInvisibleBookmarksList(Bookmark.createBookmark(book, textView.getModel().getId(), cursor, 6, false));
        }
    }
