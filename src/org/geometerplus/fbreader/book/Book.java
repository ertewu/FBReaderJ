...
public class Book extends TitledEntity<Book> {
    ...
    boolean hasSameMetainfoAs(Book other) {
        return MiscUtil.equals(getTitle(), other.getTitle()) && MiscUtil.equals(myEncoding, other.myEncoding)
                && MiscUtil.equals(myLanguage, other.myLanguage) && MiscUtil.equals(myAuthors, other.myAuthors)
                && MiscUtil.listsEquals(myTags, other.myTags) && MiscUtil.equals(mySeriesInfo, other.mySeriesInfo)
                && MiscUtil.equals(myUids, other.myUids);
    }

    void merge(Book other, Book base) {
        if (!MiscUtil.equals(getTitle(), other.getTitle()) && MiscUtil.equals(getTitle(), base.getTitle())) {
            setTitle(other.getTitle());
        }
        if (!MiscUtil.equals(myEncoding, other.myEncoding) && MiscUtil.equals(myEncoding, base.myEncoding)) {
            setEncoding(other.myEncoding);
        }
        if (!MiscUtil.equals(myLanguage, other.myLanguage) && MiscUtil.equals(myLanguage, base.myLanguage)) {
        ...
        if (!MiscUtil.equals(mySeriesInfo, other.mySeriesInfo) && MiscUtil.equals(mySeriesInfo, base.mySeriesInfo)) {
    ...
    public String toString() {
        return new StringBuilder("Book[").append(File.getPath()).append(", ").append(myId).append(", ").append(getTitle()).append("]").toString();
    }
