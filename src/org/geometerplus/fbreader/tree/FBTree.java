...
public abstract class FBTree extends ZLTree<FBTree> implements Comparable<FBTree> {
    ...
    public static enum Status {
        READY_TO_OPEN, WAIT_FOR_OPEN, ALWAYS_RELOAD_BEFORE_OPENING, CANNOT_OPEN
    };
    ...
    /**
     * Returns id used as a part of unique key above. This string must be not
     * null and be different for all children of same tree
     */
