...
public class NativeFormatPlugin extends BuiltinFormatPlugin {
    ...
    synchronized public void readMetainfo(Book book) throws BookReadingException {
        ...
        if (code != 0) {
            throw new BookReadingException("nativeCodeFailure", book.File, new String[] { String.valueOf(code), book.File.getPath() });
        }
    }
    ...
    synchronized public void readModel(BookModel model) throws BookReadingException {
        ...
        default:
            throw new BookReadingException("nativeCodeFailure", model.Book.File, new String[] { String.valueOf(code), model.Book.File.getPath() });
        }
    }
